...
- If you've encountered a bug, open a [Bug Report](https://github.com/FastClap/$REPOSITORY/issues/new?assignees=&labels=&template=bug_report.md&title=).
- If you want [PROJECT'S NAME] to have a new fonctionality, open a [Feature Request](https://github.com/FastClap/$REPOSITORY/issues/new?assignees=&labels=&template=feature_request.md&title=).

## Resolve an issue

Select an [issue](https://github.com/FastClap/$REPOSITORY/issues) that you want to resolve.
...
git clone git@github.com:FastClap/$REPOSITORY.git
...
# Create a new pull request from https://github.com/FastClap/$REPOSITORY/pulls
```
